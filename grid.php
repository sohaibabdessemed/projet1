...
<?php foreach($r as $row){ $id = $row["id"]; ?>
  <div class="col mb-4" onclick="window.document.location.href='single.php?id=<?php echo $id?>'">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <?php echo $row["type"]?>
          <span class="h6">
          <?php echo $row["choice"]." ".$row["salle"] ?>
          </span>
        </h5>
        <p class="card-text font-weight-bold"><?php echo $row["price"]?> DA</p>
      </div>
    </div>
  </div>
<?php } ?>
